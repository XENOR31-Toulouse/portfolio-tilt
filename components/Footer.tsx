  ...
  return (
    <footer className="mt-16 bg-transparent border-t-0">
      <div className="mx-auto max-w-7xl px-6 py-10 text-slate-300">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <Link href="/" className="hover:text-violet-300 transition">Accueil</Link>
              </li>
              <li>
                <Link href="/projects" className="hover:text-violet-300 transition">Projets</Link>
              </li>
              <li>
                <a href="/cv/Axel_Ibanez_CV.pdf" target="_blank" className="hover:text-violet-300 transition">CV (PDF)</a>
              </li>
              <li>
                <a href="mailto:axel.ibanez31000@gmail.com" className="hover:text-violet-300 transition">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <a
                  href="https://www.linkedin.com/in/axel-ibanez-9a2918193"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li>
                <a
                  href="mailto:axel.ibanez31000@gmail.com"
                  className="hover:text-violet-300 transition"
                >
                  Email
                </a>
        ...
        {/* Bottom */}
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between text-sm text-slate-500">
